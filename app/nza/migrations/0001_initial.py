# Generated by Django 4.2.3 on 2023-09-18 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nza.section', verbose_name='Разделы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('example', models.ManyToManyField(to='nza.example', verbose_name='Пример: ')),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nza.section', verbose_name='Разделы')),
                ('subsection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nza.subsection', verbose_name='Подраздел')),
