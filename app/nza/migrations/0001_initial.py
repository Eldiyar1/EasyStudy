# Generated by Django 4.1.6 on 2023-09-20 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('example', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='grammar', to='nza.example', verbose_name='Пример')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='subsection', to='nza.section', verbose_name='Раздел')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grammar', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='question', to='nza.grammar', verbose_name='Грамматика')),
            ],
            options={
                'verbose_name': '1. Tест',
        ...
        migrations.AddField(
            model_name='grammar',
            name='subsection',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='grammar', to='nza.subsection', verbose_name='Подраздел'),
        ),
    ]
